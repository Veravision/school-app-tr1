        ...
        <div class="sidebar-menu">
            ...
            <ul class="menu-items">
                ...
                <li class="">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="">
                            ...
                            <span class="icon-thumbnail"><i class="pg-icon">mc</i></span>
                        </li>
                        <li class="">
                ...
                <li class="">
                    ...
                    <ul class="sub-menu">
                        <li class="">
                            <a href="{{ route('post.tag') }}">Tag</a>
                            <span class="icon-thumbnail"><i class="pg-icon">t</i></span>
                        </li>
                        <li class="">
                            <a href="{{ route('post.category') }}">Category</a>
                                ...
                                <div class="notification-panel">
                                    ...
                                    <div class="notification-body scrollable">
                                        ...
                                        <div class="notification-item unread clearfix">
                                            ...
                                            <div class="option" data-bs-toggle="tooltip" data-bs-placement="left"
                                                title="mark as read">
                                                <a href="#" class="mark"></a>
                                            </div>
                ...
                <div class="dropdown pull-right d-lg-block d-none">
                  ...
                  <button class="profile-dropdown-toggle" type="button" data-bs-toggle="dropdown"
                      ...
                      <span class="thumbnail-wrapper d32 circular inline">
                          <img src="{{ Auth::guard('admin')->user()->profile_photo_url }}" alt=""
                              data-src="{{ Auth::guard('admin')->user()->profile_photo_url }}"
                              data-src-retina="{{ Auth::guard('admin')->user()->profile_photo_url }}" width="32"
                              height="32">
                      </span>
                  </button>
              @else
                  ...
                  <button class="profile-dropdown-toggle" type="button" data-bs-toggle="dropdown"
                      ...
                      <span class="thumbnail-wrapper d32 circular inline">
                          <img src="{{ Auth::user()->profile_photo_url }}" alt=""
                              data-src="{{ Auth::user()->profile_photo_url }}"
                              data-src-retina="{{ Auth::user()->profile_photo_url }}" width="32"
                              height="32">
                      </span>
                  </button>
              @else
              ...
              @endif
                  @endif
                    <div class="dropdown-menu dropdown-menu-right profile-dropdown" role="menu">
                        <a href="#" class="dropdown-item"><span>Signed in as <br /><b>{{(Auth::guard('admin')->check())? Auth::guard('admin')->user()->name:Auth::user()->name}}</b></span><br><span>{{(Auth::guard('admin')->check())? "Admin": "User"}}</span></a>
                        ...
                        @if (Auth::guard('admin')->check())
                            <form method="POST" action="{{ route('admin.logout') }}" x-data>
                                @csrf
                                <x-dropdown-link href="{{ route('admin.logout') }}" class="dropdown-item"
...
=======
          ...
          <!-- END NOTIFICATIONS LIST -->
          <a href="#" class="search-link d-lg-inline-block d-none" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
      				class="pg-icon">search</i>Type anywhere to <span class="bold">search</span></a>
        </div>
        <div class="d-flex align-items-center">
          <!-- START User Info-->
...
>>>>>>> Stashed changes
    ...
    <div id="quickview" class="quickview-wrapper" data-pages="quickview">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li class="">
                <a href="#quickview-notes" data-bs-target="#quickview-notes" data-bs-toggle="tab"
                    role="tab">Notes</a>
            </li>
            <li>
                <a href="#quickview-alerts" data-bs-target="#quickview-alerts" data-bs-toggle="tab"
                    role="tab">Alerts</a>
            </li>
            <li class="">
        ...
        <div class="overlay-content has-results m-t-20">
            ...
            <div class="container-fluid">
                ...
                <img class="overlay-brand" src="assets/img/logo.png" alt="logo"
                    data-src="assets/img/logo.png" data-src-retina="assets/img/logo_2x.png" width="78"
                    height="22">
                <!-- END Overlay Logo !-->
                <!-- BEGIN Overlay Close !-->
                ...
                <!-- END Overlay Close !-->
=======
    <div class="overlay hide mysearch modal" data-pages="search" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <!-- BEGIN Overlay Content !-->
      <div class="overlay-content has-results m-t-20">
        <!-- BEGIN Overlay Header !-->
        <div class="container-fluid">
