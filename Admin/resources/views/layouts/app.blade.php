...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link
            ...
            sizes="76x76"
            href="{{asset('pages/ico/76.png')}}"
        />
        <link
            rel="apple-touch-icon"
            sizes="120x120"
            href="{{asset('pages/ico/120.png')}}"
        />
        <link
            rel="apple-touch-icon"
            sizes="152x152"
            href="{{asset('pages/ico/152.png')}}"
        />
    ...
    <body class="fixed-header dashboard">
            ...
            <div class="sidebar-menu">
                ...
                <ul class="menu-items">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="">
                                ...
                                <span class="icon-thumbnail"
                                    ><i class="pg-icon">t</i></span
                                >
                            </li>
                            <li class="">
                                <a href="icons.html">Icons</a>
                                <span class="icon-thumbnail"
                                    ><i class="pg-icon">i</i></span
                                >
                            </li>
                            <li class="">
                                <a href="buttons.html">Buttons</a>
                                <span class="icon-thumbnail"
                                    ><i class="pg-icon">b</i></span
                                >
                            </li>
                            <li class="">
                                <a href="notifications.html">Notifications</a>
                                <span class="icon-thumbnail"
                                    ><i class="pg-icon">n</i></span
                                >
                            </li>
                            <li class="">
                            ...
                            <li class="">
                                ...
                                >
                                <span class="icon-thumbnail"
                                    ><i class="pg-icon">pa</i></span
                                >
                            </li>
                            <li class="">
                                <a href="tabs_accordian.html"
                                    >Tabs &amp; Accordions</a
                                >
                                <span class="icon-thumbnail"
                                    ><i class="pg-icon">ta</i></span
                                >
                            </li>
                            <li class="">
                                <a href="sliders.html">Sliders</a>
                                <span class="icon-thumbnail"
                                    ><i class="pg-icon">s</i></span
                                >
                            </li>
                            <li class="">
                                <a href="tree_view.html">Tree View</a>
                                <span class="icon-thumbnail"
                                    ><i class="pg-icon">tv</i></span
                                >
                            </li>
                            <li class="">
                                <a href="nestables.html">Nestable</a>
                                <span class="icon-thumbnail"
                                    ><i class="pg-icon">ns</i></span
                                >
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        ></a>
                        <span class="icon-thumbnail"
                            ><i class="pg-icon">table</i></span
                        >
                        <ul class="sub-menu">
                            <li class="">
                                <a href="tables.html">Basic Tables</a>
                                <span class="icon-thumbnail"
                                    ><i class="pg-icon">bt</i></span
                                >
                            </li>
                            <li class="">
                                <a href="datatables.html">Data Tables</a>
                                <span class="icon-thumbnail"
                                    ><i class="pg-icon">dt</i></span
                                >
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        ></a>
                        <span class="icon-thumbnail"
                            ><i class="pg-icon">map</i></span
                        >
                        <ul class="sub-menu">
                            <li class="">
                                <a href="google_map.html">Google Maps</a>
                                <span class="icon-thumbnail"
                                    ><i class="pg-icon">gm</i></span
                                >
                            </li>
                            <li class="">
                                <a href="vector_map.html">Vector Maps</a>
                                <span class="icon-thumbnail"
                                    ><i class="pg-icon">vm</i></span
                                >
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        ></a>
                        <span class="icon-thumbnail"
                            ><i class="pg-icon">effects</i></span
                        >
                        <ul class="sub-menu">
                            <li class="">
                                <a href="invoice.html">Invoice</a>
                                <span class="icon-thumbnail"
                                    ><i class="pg-icon">in</i></span
                                >
                            </li>
                            <li class="">
                                <a href="404.html">404 Page</a>
                                <span class="icon-thumbnail"
                                    ><i class="pg-icon">pg</i></span
                                >
                            </li>
                            <li class="">
                            ...
                            <li class="">
                                ...
                                <span class="icon-thumbnail"
                                    ><i class="pg-icon">bp</i></span
                                >
                            </li>
                            <li class="">
                                <a href="login.html">Login</a>
                                <span class="icon-thumbnail"
                                    ><i class="pg-icon">li</i></span
                                >
                            </li>
                            <li class="">
                                <a href="register.html">Register</a>
                                <span class="icon-thumbnail"
                                    ><i class="pg-icon">re</i></span
                                >
                            </li>
                            <li class="">
                                <a href="lock_screen.html">Lockscreen</a>
                                <span class="icon-thumbnail"
                                    ><i class="pg-icon">ls</i></span
                                >
                            </li>
                            <li class="">
                                <a href="gallery.html">Gallery</a>
                                <span class="icon-thumbnail"
                                    ><i class="pg-icon">gl</i></span
                                >
                            </li>
                            <li class="">
                                <a href="timeline.html">Timeline</a>
                                <span class="icon-thumbnail"
                                    ><i class="pg-icon">tl</i></span
                                >
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="">
                        <a
                            ...
                            rel="noreferrer"
                            target="_blank"
                            ><span class="title">Docs</span></a
                        >
                        <span class="icon-thumbnail"
                            ><i class="pg-icon">flag</i></span
                        >
                    </li>
                    <li class="m-b-40">
                        <a
                            ...
                            rel="noreferrer"
                            target="_blank"
                            ><span class="title">Changelog</span></a
                        >
                        <span class="icon-thumbnail"
                            ><i class="pg-icon">clipboard</i></span
                        >
                    </li>
                </ul>
                            ...
                            <div class="dropdown">
                                ...
                                >
                                    ...
                                    <div class="notification-panel">
                                            ...
                                            >
                                                ...
                                                <div class="heading open">
                                                    ...
                                                    <div class="more-details">
                                                        <div
                                                            class="more-details-inner"
                                                        >
                                                            <h5
                                                                class="semi-bold fs-16"
                                                            >
                                                                “Apple’s
                                                                Motivation -
                                                                Innovation
                                        ...
                                        <div
                                            class="notification-footer text-center"
                                        >
                                            <a href="#" class=""
                    ...
                    <div class="dropdown pull-right d-lg-block d-none">
                        ...
                        >
                            ...
                            <span class="dropdown-item fs-12 hint-text"
                                >Last edited by David<br />on Friday at
                                5:27PM</span
                            >
                        </div>
                    </div>
        ...
        <div id="quickview" class="quickview-wrapper" data-pages="quickview">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li class="">
                    <a
                        ...
                        data-bs-target="#quickview-notes"
                        data-bs-toggle="tab"
                        role="tab"
                        >Notes</a
                    >
                ...
                <li>
                    <a
                        ...
                        data-bs-target="#quickview-alerts"
                        data-bs-toggle="tab"
                        role="tab"
                        >Alerts</a
                    >
            ...
            <a
                class="btn-icon-link invert quickview-toggle"
                data-toggle-element="#quickview"
                data-toggle="quickview"
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane no-padding" id="quickview-notes">
                    <div
                        class="view-port clearfix quickview-notes"
                        id="note-views"
                    >
                        <!-- BEGIN Note List !-->
                                ...
                                <ul class="pull-right">
                                    ...
                                    <li>
                                        <a
                                            ...
                                            ><i class="pg-icon">add</i></a
                                        >
                                    </li>
                                </ul>
                                <button
                                    aria-label=""
                                    class="btn-remove-notes btn btn-xs btn-block hide"
                                >
                                    <i class="pg-icon">close</i>Delete
                                </button>
                            </div>
                            <ul>
                                <!-- BEGIN Note Item !-->
                                ...
                                >
                                    <div class="left">
                                        <!-- BEGIN Note Action !-->
                                        <div
                                            class="form-check warning no-margin"
                                        >
                                            <input
                                                id="qncheckbox1"
                                                type="checkbox"
                                    ...
                                    <!-- BEGIN Note Details !-->
                                    <div
                                        class="d-flex right justify-content-end"
                                    >
                                        <!-- BEGIN Note Date !-->
                            ...
                            <div>
                                ...
                                <div class="body">
                                    <div>
                                        ...
                                        <div class="content">
                                            <div
                                                class="quick-note-editor full-width full-height js-input"
                        ...
                        <div class="view bg-white">
                            ...
                            <div class="navbar navbar-default navbar-sm">
                                <div class="navbar-inner">
                                    ...
                                    <a
                                        href="javascript:;"
                                        class="action p-l-10 link text-color"
                                        data-navigate="view"
                                        data-view-port="#chat"
                                    ...
                                    <a
                                        href="#"
                                        class="action p-r-10 pull-right link text-color"
                                    >
                            ...
                            >
                                ...
                                <div class="list-view-group-container">
                                    ...
                                    <div
                                        class="list-view-group-header text-uppercase"
                                    >
                                        Calendar
                                    </div>
                                    ...
                                    <ul>
                                        ...
                                        <li class="alert-list">
                                            ...
                                            >
                                                ...
                                                <p
                                                    class="p-l-10 overflow-ellipsis fs-12"
                                                >
                                                ...
                                                <p
                                                    class="p-r-10 ml-auto fs-12 text-right"
                                                >
                                    ...
                                    <ul>
                                        ...
                                        <li class="alert-list">
                                            ...
                                            >
                                                ...
                                                <p
                                                    class="col overflow-ellipsis fs-12 p-l-10"
                                                >
                                                    <span
                                ...
                                <div class="list-view-group-container">
                                    ...
                                    <ul>
                                        ...
                                        <li class="chat-user-list clearfix">
                                            ...
                                            >
                                                <span
                                                    class="thumbnail-wrapper d32 circular bg-success"
                                                >
                                                    <img
                                                        width="34"
                                                        height="34"
                                                ...
                                                <p class="p-l-10">
                                                    ...
                                                    >
                                                    <span
                                                        class="block text-color hint-text fs-12"
                                                        >Hello there</span
                                                    >
                                                </p>
                                            </a>
                        ...
                        <div class="view chat-view bg-white clearfix">
                            ...
                            <div class="navbar navbar-default">
                                <div class="navbar-inner">
                                    <a
                                        href="javascript:;"
                                        class="link text-color action p-l-10 p-r-10"
                                        data-navigate="view"
                                        data-view-port="#chat"
                                        data-view-animation="push-parrallax"
                                    >
                                    ...
                                    <a
                                        href="#"
                                        class="link text-color action p-r-10 pull-right"
                                    >
                                        <i class="pg-icon">more_horizontal</i>
                                    </a>
                                </div>
                            ...
                            <div class="chat-inner" id="my-conversation">
                                ...
                                <div class="message clearfix">
                                    <div
                                        class="profile-img-wrapper m-t-5 inline"
                                    >
                                        <img
                                            class="col-top"
                                            width="30"
                            ...
                            <!-- BEGIN Chat Input  !-->
                            <div
                                class="b-t b-grey bg-white clearfix p-l-10 p-r-10"
                            >
                                <div class="row">
                                    ...
                                    <div
                                        class="col-2 link text-color m-l-10 m-t-15 p-l-10 b-l b-grey col-top"
                                    >
                                        <a href="#" class="link text-color"
                                            ><i class="pg-icon">camera</i></a
                                        >
                                    </div>
                                </div>
                            </div>
            ...
            <div class="overlay-content has-results m-t-20">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <p class="fs-13 hint-text m-l-10 m-b-0">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="d-flex m-t-15">
                                    ...
                                    <div
                                        class="thumbnail-wrapper d48 circular bg-success text-white"
                                    >
                                        <img
                                            width="36"
                                            height="36"
        ...
        @stack('modals') @include('shared/script') @livewireScripts
    </body>
</html>
