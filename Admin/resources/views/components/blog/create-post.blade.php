         ...
         <div class="row">
             <div class="col-lg-4" style="width: 100%; height: 100%">
                 <div id="card-linear-color" class="card card-default">
                     ...
                     <div class="card-body">
                         <form method="post" action="{{ route('post.store') }}" id="blog-post-form" role="form"
                                                                             ...
                                                                             <div class="col-md-6">
                                                                                 <label class="form-label">Select
                                                                                     ...
                                                                                     <input type="file" class="filepond"
                                                                                         style = "width: 18rem !important;" name="thumbnail">
                                                     ...
                                                     <div class="row text-center pt-4">
                                                         ...
                                                         <div class="col-md-12" id="otherUserAuthor"
                                                             ...
                                                             <p>
                                                                 ...
                                                                 <input id='users-list-tags' name="author_list[]" class='users-list'
                                                                     value=''>
                                                             </p>
                                                         </div>
                                                     </div>
                                         ...
                                         <div class="padding-20 sm-padding-5 sm-m-b-20 sm-m-t-20 bg-white clearfix">
                                             <ul class="pager wizard no-style">
                                                 ...
                                                 <li class="next finish hidden">
                                                     <button onclick="submit_post()" aria-label="" class="btn btn-primary btn-cons btn-animated from-left pull-right" type="submit">
                                                         <span>Finish</span>
                                                         <span class="hidden-block">
                                                 ...
                                                 <li class="next finish hidden">
                                                     <button onclick="alert('my preview')" aria-label="" class="btn btn-info btn-cons btn-animated from-left pull-right" type="button">
                                                         <span>Preview</span>
                                                         <span class="hidden-block">
                                                             <i class="material-icons fs-16">query_stats</i>
                                                         </span>
 ...
 @section('createpostscripts')
     ...
     <script>
         (function() {
             var inputElm = document.querySelector('#users-list-tags');
...
`
     ...
     <script>
        let submit_post = () => {
            let blog_post_form = $('#blog-post-form');
