              ...
              <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 ">
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <h2 class="mw-80">Get started with categories.</h2>
                      <p class="fs-16 mw-80 m-b-40">Find your people. Engage your customers. Build your blog. Do it all with categories.</p>
                      <form method="post" action="{{ route('post.category.store') }}" id="form-personal" role="form" autocomplete="off" >
                        @csrf
                        <div class="row">
                          <div class="col-md-12">
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group form-group-default required">
                              ...
                              <input type="text" class="form-control" name="meta_title" value="{{ old('meta_title') }}" placeholder="" required>
                            </div>
                          </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                              <div class="form-group form-group-default input-group required">
                                <div class="form-input-group">
                                  <label>Slug</label>
                                  <input type="text" class="form-control" name="slug" value="{{ old('slug') }}" placeholder="" required>
                                </div>
                            ...
                            <div class="col-md-6">
                              <div class="form-group form-group-default form-check-group d-flex align-items-center">
                                <div class="form-check switch switch-lg success full-width right m-b-0">
                                  <input type="checkbox" id="switchSample" name="status" value="1" {{old('status') == 1 ? 'checked' : ''}} selected>
                        ...
                        <div class="row m-t-25">
                          <div class="col-xl-6 p-b-10">
                            <p class="small-text hint-text">By clicking the "Create!" button, you are creating a Category, and you agree to categories' <a href="#">Terms of Use</a> and <a href="#">Privacy Policy</a>.</p>
                          </div>
                          <div class="col-xl-4">
                            <button aria-label="" class="btn btn-primary pull-right btn-lg btn-block w-100" type="submit">Create </button>
                        </div>
                        </div>
                      </form>
                    </div>
